                                ...
                                <div class="flex p-8 border border-gray-200 rounded-lg bg-serv-upload-bg h-128">
                                    <div class="m-auto text-center">
                                        ...
                                        <div class="relative mt-0 md:mt-6">
                                            ...
                                            @if (isset($order->file))
                                                <a href="{{ url(Storage::url($order->file ?? '')) }}" class="px-4 py-2 mt-2 text-left text-gray-700 rounded-xl bg-serv-hr"
                                                    onclick="return confirm('Are you sure want to download this file?')">
                                                    Download File
                                                </a>
                                            @else
                                                <p class="text-sm text-gray-400">File Note Available</p>
                                            @endif
                                        ...
                                        <div class="p-1 mt-5">
                                            <div class="grid grid-cols-6 gap-6">
                                                <div class="col-span-6">
                                                    ...
                                                    <textarea placeholder="Enter your biography here.." type="text" name="service-name" id="service-name" autocomplete="service-name" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500
                                                    focus:border-green-500 sm:text-sm" rows="4" readonly>{{ $order->note }}</textarea>
                                                </div>
                                            </div>
                                        </div>
