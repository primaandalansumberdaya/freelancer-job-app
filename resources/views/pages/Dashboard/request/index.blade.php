                            ...
                            <table class="w-full" aria-label="Table">
                                ...
                                <tbody class="bg-white">
                                    ...
                                    <tr class="text-gray-700 border-b">
                                        ...
                                        <td class="px-1 py-5 text-sm">
                                            <a href="{{ route('member.request.show', 2 )}} " class="px-4 py-2 mt-2 text-left text-white rounded-xl bg-serv-email">
                                                Details
                                            </a>
                                        </td>
                                    </tr>
                                    ...
                                    <tr class="text-gray-700">
                                        ...
                                        <td class="px-1 py-5 text-sm">
                                            <a href="{{ route('member.request.show', 3)}}" class="px-4 py-2 mt-2 text-left text-white rounded-xl bg-serv-email">
                                                Details
                                            </a>
                                        </td>
                                    </tr>
