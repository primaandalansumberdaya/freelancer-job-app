                            ...
                            <form action="{{ route('member.service.store') }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="">
                                    <div class="px-4 py-5 sm:p-6">
                                        <div class="grid grid-cols-6 gap-6">
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                focus:border-green-500 sm:text-sm" value="{{ old('title') }}" required>
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500
                                                focus:border-green-500 sm:text-sm" value="{{ old('description') }}" required>

                                                @if ($errors->has('description'))
                                                    <p class="mb-3 text-sm text-red-500">{{ $errors->first('description') }}</p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                <select id="delivery_time" name="delivery_time" autocomplete="delivery_time" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                                    ...
                                                    <option value="2" class="">2 Days</option>
                                                ...
                                                @if ($errors->has('delivery_time'))
                                                    <p class="mb-3 text-sm text-red-500">{{ $errors->first('delivery_time') }}</p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-span-6 sm:col-span-3">
                                                <select id="revision_limit" name="revision_limit" autocomplete="revision_limit" class="block w-full px-3 py-3 pr-10 mt-1 bg-white border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" required>
                                                    ...
                                                    <option value="2" class="">2 Revision</option>
                                                    <option value="5" class="">5 Revision</option>
                                                    <option value="7" class="">7 Revision</option>
                                                    <option value="10" class="">10 Revision</option>
                                                    <option value="12" class="">12 Revision</option>
                                                </select>

                                                @if ($errors->has('revision_limit'))
                                                    <p class="mb-3 text-sm text-red-500">{{ $errors->first('revision_limit') }}</p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                @if ($errors->has('price'))
                                                    <p class="mb-3 text-sm text-red-500">{{ $errors->first('price') }}</p>
                                                @endif
                                            </div>
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                <input placeholder="Keunggulan Kamu 1" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                                <input placeholder="Keunggulan Kamu 2" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                                <input placeholder="Keunggulan Kamu 3" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                                            ...
                                            <div class="col-span-6">
                                                ...
                                                @if ($errors->has('note'))
                                                    <p class="mb-3 text-sm text-red-500">{{ $errors->first('note') }}</p>
                                                @endif
                                    ...
                                    <div class="px-4 py-3 text-right sm:px-6">
                                        ...
                                        <a href="{{ route('member.service.index') }}" type="button" class="inline-flex justify-center px-4 py-2 mr-4 text-sm font-medium
                                        text-gray-700 bg-white border border-gray-600 rounded-lg shadow-sm hover:bg-white focus:outline-none
                                        focus:ring-2 focus:ring-offset-2 focus:ring-gray-300" onclick="return confirm('Are you sure want to cancel?, Any changes you make will not be saved')">
                                            Cancel
                                        </a>
